...
def create_post(request):
    ...
    if not item_indexes:
        ...
        error_message = "Please add at least one item to your post."
    ...
    # ============================================================
    # VALIDATE EVERY ITEM BEFORE CREATING ANY DATABASE RECORD
    # ============================================================

    validation_errors = []

    for position, i in enumerate(item_indexes, start=1):
        ...
        with transaction.atomic():
            ...
            for i in item_indexes:
                ...
                if has_sizes_for_item:
                    ...
                    # IMPORTANT:
                    # JavaScript uses simple_quantity_INDEX
                    simple_quantity = int(
                        request.POST.get(
                            f'simple_quantity_{i}'
                        )
